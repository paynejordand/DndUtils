...
## What it will do
1. Create a random character at a specified level
2. Create an in-depth character (armor class, spell slots, attack rolls, etc)
3. Allow users to add Homebrew races, classes, feats, etc.
## Things undecided
...
Use and redistribution of this software falls under the MIT License while the licensing for the content of the software follows.
